...
// Pre-defined
#ifndef MRH_CORE_LOG_FILE_PATH
    #define MRH_CORE_LOG_FILE_PATH "/var/log/mrh/mrhcore.log"
#endif
#ifndef MRH_CORE_BACKTRACE_FILE_PATH
    #define MRH_CORE_BACKTRACE_FILE_PATH "/var/log/mrh/bt_mrhcore.log"
#endif
...
Logger::Logger() noexcept : us_Lines(0)
{
    ...
    {
        Log(Logger::WARNING, "Failed to open log file: " MRH_CORE_LOG_FILE_PATH,
            "Logger.cpp", __LINE__);
    }
    
    if (f_BacktraceFile.is_open() == false)
    {
        Log(Logger::WARNING, "Failed to open backtrace file: " MRH_CORE_LOG_FILE_PATH,
            "Logger.cpp", __LINE__);
    }
}
